function ProjectCard({ title, year, image, tags = [], onClick, githubUrl, type }) {
      ...
      <div className="relative aspect-[4/3] md:aspect-[5/4] rounded-[2rem] overflow-hidden mb-6 bg-gray-50">
        ...
        {type === 'development' && githubUrl && (
          <button
            ...
            className="absolute top-4 right-4 bg-gray-900/80 hover:bg-gray-900 text-white px-4 py-2 rounded-full flex items-center gap-2 transition-all duration-300 backdrop-blur-sm"
          >
