  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/3] md:aspect-[5/4] rounded-[2rem] overflow-hidden mb-6 bg-gray-50">
        ...
        {/* In Progress Badge */}
        {status === 'in-progress' && (
          <div className="absolute top-4 left-4 bg-amber-500 text-white px-4 py-2 rounded-full flex items-center gap-2 backdrop-blur-sm shadow-lg">
        ...
        {type === 'development' && githubUrl && (
          <button
            ...
            className="absolute bottom-4 right-4 bg-gray-900/80 hover:bg-gray-900 text-white p-3 rounded-full flex items-center justify-center transition-all duration-300 backdrop-blur-sm shadow-lg hover:scale-110"
          >
