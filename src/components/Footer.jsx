...
function Footer() {
  const driveLink = "https://drive.google.com/drive/folders/1HBLCawmreYG0ja0IYxFm_d7feFicMxxF?usp=sharing"; // Google Drive link
    ...
    <footer id="footer" className="relative bg-white text-gray-900 font-poppins">
      ...
      <div className="relative bg-gradient-to-r from-purple-50 via-purple-100 to-purple-50 py-3 md:py-4 overflow-hidden border-y border-purple-200">
        ...
        <div className="flex items-center gap-8 md:gap-12 animate-scroll whitespace-nowrap">
          ...
          <span className="text-purple-300">•</span>
          <span className="text-purple-600 text-base md:text-xl font-medium">Dashboard</span>
          <span className="text-purple-300">•</span>
          <span className="text-purple-600 text-base md:text-xl font-medium">Wireframe</span>
          <span className="text-purple-300">•</span>
          <span className="text-purple-600 text-base md:text-xl font-medium">User Research</span>
          <span className="text-purple-300">•</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-8">
            ...
            <div className="text-center md:text-left">
              ...
              <div className="space-y-3 text-sm">
                <a href="mailto:prarinporn.ch@gmail.com" className="flex items-center justify-center md:justify-start gap-2 text-gray-600 hover:text-purple-600 transition group">
            ...
            <div className="text-center md:text-left">
              ...
              <div className="flex flex-col gap-3">
                <a href="https://www.linkedin.com/in/prarinporn-chookaew-b7691532a/" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center md:justify-start gap-3 text-gray-600 hover:text-purple-600 transition group">
                  <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center group-hover:bg-purple-100 transition border border-gray-200">
                ...
                <a href="https://github.com/dearprarinporn" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center md:justify-start gap-3 text-gray-600 hover:text-purple-600 transition group">
                  <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center group-hover:bg-purple-100 transition border border-gray-200">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://www.behance.net/gallery/228163835/Prarinporn-Chookaew-Portfolio" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center md:justify-start gap-3 text-gray-600 hover:text-purple-600 transition group">
                  <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center group-hover:bg-purple-100 transition border border-gray-200">
                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
